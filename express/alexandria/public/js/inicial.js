...
const livros_disponiveis = await fetch(`data/usuario?id_user=${id}`).then(response => response.json());
const discos_disponiveis = await fetch(`data/usuario?id_user=${id}`).then(response => response.json());
